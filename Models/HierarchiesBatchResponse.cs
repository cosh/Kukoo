...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class HierarchiesBatchResponse : IEquatable<HierarchiesBatchResponse>
    { 
        /// <summary>
        ...
        /// </summary>
        /// <value>List of hierarchy or error objects corresponding by position to the \&quot;get\&quot; array in the request. Hierarchy object is set when operation is successful and error object is set when operation is unsuccessful.</value>

        [DataMember(Name="get")]
        public List<TimeSeriesHierarchyOrError> Get { get; private set; }
        ...
        /// </summary>
        /// <value>List of hierarchy or error object corresponding by position to the \&quot;put\&quot; array in the request. Hierarchy object is set when operation is successful and error object is set when operation is unsuccessful.</value>

        [DataMember(Name="put")]
        public List<TimeSeriesHierarchyOrError> Put { get; private set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((HierarchiesBatchResponse)obj);
        }

        /// <summary>
        /// Returns true if HierarchiesBatchResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of HierarchiesBatchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HierarchiesBatchResponse other)
        {
        ...
        public static bool operator ==(HierarchiesBatchResponse left, HierarchiesBatchResponse right)
        {

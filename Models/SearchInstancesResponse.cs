...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SearchInstancesResponse : IEquatable<SearchInstancesResponse>
    { 
        /// <summary>
        /// The list of instances matching the query based on the input. May be empty.
        /// </summary>
        /// <value>The list of instances matching the query based on the input. May be empty.</value>

        [DataMember(Name="hits")]
        public List<InstanceHit> Hits { get; private set; }

        /// <summary>
        /// Total number of instances matching the query based on the input.
        /// </summary>
        /// <value>Total number of instances matching the query based on the input.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SearchInstancesResponse)obj);
        }

        /// <summary>
        /// Returns true if SearchInstancesResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of SearchInstancesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchInstancesResponse other)
        {
        ...
        public static bool operator ==(SearchInstancesResponse left, SearchInstancesResponse right)
        {
